...
import logo from "../../assets/934logo.png"
  ...
  return (
    <nav class=" z-0 fixed w-full h-[100px] flex justify-evenly items-center px-4 bg-[#742a2a] text-yellow-500 border-b-8 border-b-yellow-500 ">
      ...
      <div class="flex w-1/3 pt-2 ml-[-100px] mt-4 p-6">
        <img src={logo} alt="Daily Prophet" style={{ width: "90px", heigth: "90px" }} />
        <h1 class="text-gray-100 text-4xl items-center justify-center text-left mt-[20px]"><span class="text-yellow-500">H</span>ogwarts <span class="text-yellow-500">E</span>xpress</h1>
      </div>
